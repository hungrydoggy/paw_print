...
static void _t_loadParsingTree () {
    ...
    auto table_correct = 
		...
		"-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n" \
		"  0 |     |         |         |       |       |             |         s3 |   s2 |     s5 |  s1 |     s4 | go6 |            | go11 |             |  go8 | go7 |      go9 |     go10 | \n" \
		"  1 | r13 |     r13 |         |       |   r13 |         r13 |            |  r13 |        |     |        |     |            |      |             |      |     |          |          | \n" \
		"  2 |     |         |         |       |       |             |         s3 |   s2 |     s5 |  s1 |     s4 | go6 |            | go11 |             | go12 |     |      go9 |     go10 | \n" \
		"  3 |     |         |         |       |       |         s13 |            |      |        |     |    s14 |     |       go16 |      |        go15 |      |     |          |          | \n" \
		"  4 | r15 |     r15 |         |   s17 |   r15 |         r15 |            |  r15 |        |     |        |     |            |      |             |      |     |          |          | \n" \
		"  5 | r14 |     r14 |         |       |   r14 |         r14 |            |  r14 |        |     |        |     |            |      |             |      |     |          |          | \n" \
		"  6 |  r6 |      r6 |         |       |    r6 |          r6 |         s3 |   r6 |        |     |    s18 | go6 |            | go19 |             |      |     |          |          | \n" \
		"  7 | acc |         |         |       |       |             |            |      |        |     |        |     |            |      |             |      |     |          |          | \n" \
		"  8 |  r1 |         |         |       |       |             |            |      |        |     |        |     |            |      |             |      |     |          |          | \n" \
		"  9 | r17 |     r17 |         |       |   r17 |         r17 |            |  r17 |        |     |        |     |            |      |             |      |     |          |          | \n" \
		" 10 | r12 |     r12 |         |       |   r12 |         r12 |            |   s2 |        |     |        |     |            |      |             |      |     |     go20 |     go10 | \n" \
		" 11 | r16 |     r16 |         |       |   r16 |         r16 |            |  r16 |        |     |        |     |            |      |             |      |     |          |          | \n" \
		...
		" 21 |     |         |         |       |       |             |         s3 |   s2 |     s5 |  s1 |     s4 | go6 |            | go11 |             | go25 |     |      go9 |     go10 | \n" \
		" 22 |  r4 |      r4 |         |       |    r4 |          r4 |            |   r4 |        |     |        |     |            |      |             |      |     |          |          | \n" \
		" 23 |     |         |         |       |       |             |            |      |        |     |    s14 |     |       go16 |      |        go26 |      |     |          |          | \n" \
		" 24 |     |         |         |       |       |             |         s3 |   s2 |     s5 |  s1 |     s4 | go6 |            | go11 |             | go27 |     |      go9 |     go10 | \n" \
		" 25 |     |         |         |       |    r7 |          r7 |            |      |        |     |        |     |            |      |             |      |     |          |          | \n" \
		" 26 |     |         |         |       |       |          r9 |            |      |        |     |        |     |            |      |             |      |     |          |          | \n" \
		" 27 |     |     s28 |         |       |       |             |            |      |        |     |        |     |            |      |             |      |     |          |          | \n" \
